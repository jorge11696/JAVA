...
public class MostrarArticulos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonGroupMostrarDeteriorado = new javax.swing.ButtonGroup();
        ...
        setPreferredSize(new java.awt.Dimension(712, 600));
        ...
        buttonGroupMostrarDeteriorado.add(jRadioButtonMostrarDeterioradoSI);
        jRadioButtonMostrarDeterioradoSI.setText("Si");
        jRadioButtonMostrarDeterioradoSI.setEnabled(false);

        buttonGroupMostrarDeteriorado.add(jRadioButtonMostrarDeterioradoNO);
            ...
            .addGroup(jPanelAutorLayout.createSequentialGroup()
                ...
                .addGroup(jPanelAutorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelAutorLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jTextCodAut, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(40, 40, 40))))
        );
        ...
        buttonGroupEbook.add(jRadioMostrarEbookSI);
        jRadioMostrarEbookSI.setText("Si");
        jRadioMostrarEbookSI.setEnabled(false);

        buttonGroupEbook.add(jRadioMostrarEbookNO);
        ...
        buttonGroupTapa.add(jRadioMostrarTapaDURA);
        jRadioMostrarTapaDURA.setText("Dura");
        jRadioMostrarTapaDURA.setEnabled(false);

        buttonGroupTapa.add(jRadioMostrartapaBLANDA);
    ...
    private void jButtonPrimeroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrimeroActionPerformed
        try {
            ...
            Logger.getLogger(MostrarArticulos.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private javax.swing.ButtonGroup buttonGroupMostrarDeteriorado;
    ...
    private void cargaCamposObj(Articulo a) {
        String sentSql = "";
        int ok = -1;
        Autor aut;
        try{
            ...
            if(con.tamanyo() == 0){
                JOptionPane.showMessageDialog(null, "No hay ningún artículo", "Error", JOptionPane.ERROR_MESSAGE);
            }
            actualizaBotones();
    ...
    private void actualizaBotones() throws SQLException {
        try{          
        con.conecta();
        jLNavegacion.setText("Artículo: " + con.posRs() + "/" + con.tamanyo());
        if (con.posRs() == 1) {
        ...
        if ((con.posRs() > 1) && (con.posRs() < con.tamanyo())) {
            jButtonAnterior.setEnabled(true);
            jButtonPrimero.setEnabled(true);
            jButtonSiguiente.setEnabled(true);
            jButtonFinal.setEnabled(true);
